...
var config = {
    entry: { //配置入口文件,有几个写几个
        ...
        citylist: './src/js/citylist.js',
        viewmore: './src/js/viewmore.js',
        search: './src/js/search.js',
        activitydetail: './src/js/activitydetail.js',
    ...
    module: {
        loaders: [
            ...
            },
            {
                ...
                loader: process.env.NODE_ENV=='development'?'file-loader?name=/less/fonts/[name].[ext]':'file-loader?name=../fonts/[name].[ext]'
            },
            {
